...
function CkGzip_CompressString(objHandle: HCkGzip; inStr: PWideChar; destCharset: PWideChar; outBytes: HCkByteData): wordbool; stdcall;
...
function CkGzip_Decode(objHandle: HCkGzip; encodedStr: PWideChar; encoding: PWideChar; outBytes: HCkByteData): wordbool; stdcall;
...
function CkGzip_IsUnlocked(objHandle: HCkGzip): wordbool; stdcall;

function CkGzip_ReadFile(objHandle: HCkGzip; path: PWideChar; outBytes: HCkByteData): wordbool; stdcall;
...
function CkGzip_IsUnlocked; external DLLName;
